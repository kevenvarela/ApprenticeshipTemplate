...
public class Endpoints {
    ...
    public static final String AGREGAR_CARRITO = HOME + "/carrito_nuevo";
    public static final String OBTENER_CARRITO = HOME + "/listCarts";
    public static final String AGREGAR_ITEM = HOME + "/addToCart";
